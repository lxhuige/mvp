...
public class FlowLayout extends ViewGroup {
    ...
    private Views.onItemListener listener;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (listener != null && height >= 2 * lineHeight) {
                listener.onItemClickPos(height, this);
            }
            if (isShowMore && height >= 2 * lineHeight) {
                break;
            }
        }
    ...
    public void setListener(Views.onItemListener listener) {

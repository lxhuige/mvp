...
public class PagingScrollHelper {
        ...
        public boolean onFling(int velocityX, int velocityY) {
            ...
            if (mOrientation == ORIENTATION.VERTICAL) {
                ...
                if (layoutManager instanceof HorizontalPageLayoutManager) {
                    int sideWidth;
                    if (p == 1) {
                        sideWidth = ((HorizontalPageLayoutManager) layoutManager).itemWidthUsed / 2;
                        endPoint = p * (((HorizontalPageLayoutManager) layoutManager).itemViewWidth - sideWidth);
                    } else if (p == mRecyclerView.getChildCount() - 1) {
                        sideWidth = ((HorizontalPageLayoutManager) layoutManager).itemWidthUsed;
                        endPoint = p * (((HorizontalPageLayoutManager) layoutManager).itemViewWidth) - sideWidth;
                    } else {
                        sideWidth = ((HorizontalPageLayoutManager) layoutManager).itemWidthUsed / 2;
                        endPoint = p * (((HorizontalPageLayoutManager) layoutManager).itemViewWidth) - sideWidth;
    ...
    public class MyOnScrollListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            offsetY += dy;
            offsetX += dx;
            LogUtils.INSTANCE.e("offsetX----" + offsetX);
        }
    }
    ...
    private int getPageIndex() {
        ...
        if (mOrientation == ORIENTATION.VERTICAL) {
            ...
            if (layoutManager instanceof HorizontalPageLayoutManager) {
                sideWidth = ((HorizontalPageLayoutManager) layoutManager).itemWidthUsed * 2;
                sideWidth = Math.abs(sideWidth);
            }

            p = startX / (mRecyclerView.getWidth() - sideWidth);
        }
        LogUtils.INSTANCE.e("offsetX---index-" + p);
        return p;
    }
    ...
    private int getStartPageIndex() {
        ...
        if (mOrientation == ORIENTATION.VERTICAL) {
            ...
            int sideWidth;
            if (layoutManager instanceof HorizontalPageLayoutManager) {
                sideWidth = ((HorizontalPageLayoutManager) layoutManager).itemViewWidth - ((HorizontalPageLayoutManager) layoutManager).itemWidthUsed / 2;
                p = startX / sideWidth;
            } else {
        ...
        LogUtils.INSTANCE.e("mRecyclerView  index---" + p);
        return p;
    }
